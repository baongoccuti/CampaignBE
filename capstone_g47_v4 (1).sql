...
generalreport_id int primary key not null auto_increment,
...
INSERT INTO Campaign (campaign_id, name, start_date,end_date, description,title, location,image, current_Status_id, status)
VALUES 
(1, 'Mùa hè Xanh năm 2019', '2019-07-07','2019-07-18','','','Xã Thanh Đức - Huyện Thanh Chương','',3, 1),
(2, 'Mùa hè Xanh năm 2020', '2020-07-11','2020-07-23','','','Xã Châu Tiến - Huyện Quỳ Hợp','',3, 1),
(3, 'Mùa hè Xanh năm 2022', '2022-07-18','2022-07-29','','','Xã Nga My - Huyện Tương Dương','',3, 1),
(4, 'Mùa hè Xanh năm 2023', '2023-07-27','2023-08-07','','','Xã Bắc Sơn - Huyện Quỳ Hợp','',3, 1);

INSERT INTO TaskReport (taskreport_id, name, description,title,due_date, note, current_Status_id,campaign_id, user_id)
VALUES 
...
Phát thuốc miễn phí cho bệnh nhân','khám thuốc cho người nghèo','2023-08-01','note1',3,4,3),
(2, 'Vệ sinh môi trường','Trồng cây, hoa, dọn dẹp vệ sinh, cải tạo đường góp phần xây dựng nông thôn mới','Môi trường xanh','2023-08-05','note1',3,4,4);

INSERT INTO Issues (issue_id, title, description, assignee, start_date, due_date, current_Status_id, user_id, taskreport_id)
VALUES 
(1, 'thiếu ngân sách', 'không đủ ngân sách để thực hiện mua thuốc phát như dự kiến','ban kế hoạch','2019-07-10','2019-07-15',3,5,1),
(2,'thiếu tình nguyện viện' , 'không đủ tình nguyện viên dự kiến','ban kế hoạch', '2023-07-20', '2023-07-25',3,3,2);
...
INSERT INTO RequestVolunteer (id, name, email, phone, date_of_birth, address, reason, status, campaign_id)
VALUES 
(1, 'Nguyễn Thị An', 'annguyen008@gmail,com','0835652456','2000-07-08','Hà Nội', 'yêu thích việc đi từ thiện',1,4),
(2, 'Nguyễn Thị Bình An', 'binhannguyen001@gmail,com','0956787345','2001-07-10','Hà Nội', 'nâng cao khả năng tổ chức đội', 1, 4);

INSERT INTO Story (story_id, name, content, title, created_at,image, campaign_id) 
VALUES 
(1, 'câu chuyện mùa hè xanh 2018', '', '', '2018-07-01','', 1);
INSERT INTO News (new_id, title, content, created_date, image) 
VALUES 
(1, 'nghe kể chuyện', 'xin chào các bạn','2018-07-01','');